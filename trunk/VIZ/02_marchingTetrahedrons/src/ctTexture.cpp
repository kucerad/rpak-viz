...
void CTtexture::makeView(v3 normal, float z){
	...
	v3 minV(1000, 1000, 1000);
	v3 maxV(-1000, -1000, -1000);
	getBox(minV, maxV);

	v3 center((minV.x+maxV.x)/2, (minV.y+maxV.y)/2, (minV.z+maxV.z)/2);
	float rescale = sqrt((maxV.x-minV.x)/500 * (maxV.x-minV.x)/500 + (maxV.y-minV.y)/500 * (maxV.y-minV.y)/500)/1.4142135;
